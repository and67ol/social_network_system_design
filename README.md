...
|--------------------|------------------------------------|-------------------|
| Посты — медиа      | 1.16 GB/s                          | 36 581.76 TB      |
...
## 1) Посты — медиа (36_581.76 TB; 7.81 ГБ/s; 6018 IOPS)

| Тип дисков            | Объём / Скорость / IOPS        | disks_cap (по ёмкости) | disks_bw (по пропускной) | IOPS   | Итого дисков |
|-----------------------|--------------------------------|------------------------|--------------------------|--------|--------------|
| **HDD 32 TB**         | 32 TB / 100 MB/s / 100 IOPS    | 1 143.18               | 78.1                     | 60.18  | 1 144        |
| **SSD (SATA) 100 TB** | 100 TB / 500 MB/s / 1 000 IOPS | 365.82                 | 15.62                    | 6.018  | 366          |
| **NVMe 30 TB**        | 30 TB / 3 GB/s / 10 000 IOPS   | 1 219.39               | 2.60                     | 0.6018 | 1 220        |

**HDD 32 TB / 100 МБ/с / 100 IOPS**

disks_cap = 36_581.76 / 32 = 1 143.18
disks_bw = 7.81 ГБ/s / 1e8 = 78.1
disks_iops = 6018 / 100 = 60.18
disks = 1 144

**SSD (SATA) 100 TB / 500 МБ/с / 1_000 IOPS**

disks_cap = 36_581.76 / 100 = 365.8176
disks_bw = 7.81 ГБ/s / 5e8 = 15.62
disks_iops = 6018 / 1_000 = 6.018
disks = 366

**NVMe 30 TB / 3 ГБ/с / 10 000 IOPS**

disks_cap = 36_581.76 / 30 = 1_219.392
disks_bw = 7.81 ГБ/s / 3 ГБ/с = 2.60333
disks_iops = 6018 / 10_000 = 0.6018
disks = 1_220

## 2) Посты — мета (14.50656 TB; 12.06 МБ/с; 6_018 IOPS)
...
## 3) Комментарии — мета (110.376 TB; 5.8 МБ/с; 5_787 IOPS)
...
| Подсистема         | HDD 32 TB | **SSD 100 TB** | NVMe 30 TB |
|--------------------|-----------|----------------|------------|
| Посты — медиа      | 1 144     | 366            | 1 220      |
| Посты — мета       | 61        | 7              | 1          |
| Комментарии — мета | 58        | 6              | 4          |
| Реакции — мета     | 47        | 5              | 1          |
